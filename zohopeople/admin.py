...
class ZohoPeopleFormTokenAdmin(admin.ModelAdmin):
    ...
    Access is restricted to superusers only. Token fields are displayed
    as read-only (they are encrypted at rest) to prevent accidental exposure
    or modification through the admin UI.
    """
